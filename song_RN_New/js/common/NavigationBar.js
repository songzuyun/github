...
export default class NavigationBar extends Component{
    ...
    render(){
        ...
        let titleView = this.props.titleView?this.props.titleView:<Text style={[styles.title,this.props.titleColor]}>{this.props.title}</Text>
...
const styles = StyleSheet.create({
    ...
    statusBar:{
        height:Platform.OS==='ios'?STATUS_TAR_HEIGHT:0,
    }
})